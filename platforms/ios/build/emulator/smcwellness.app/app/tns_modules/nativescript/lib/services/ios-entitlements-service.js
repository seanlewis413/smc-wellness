...
class IOSEntitlementsService {
    ...
    getDefaultAppEntitlementsPath(projectData) {
        ...
        const entitlementsPath = path.join(projectData.projectDir, constants.APP_FOLDER_NAME, constants.APP_RESOURCES_FOLDER_NAME, this.$mobileHelper.normalizePlatformName(this.$devicePlatformsConstants.iOS), entitlementsName);
