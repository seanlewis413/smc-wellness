...
class IOSProjectService extends projectServiceBaseLib.PlatformProjectServiceBase {
    constructor($fs, $childProcess, $cocoapodsService, $errors, $logger, $iOSEmulatorServices, $injector, $projectDataService, $prompter, $config, $devicePlatformsConstants, $devicesService, $mobileHelper, $hostInfo, $pluginVariablesService, $xcprojService, $iOSProvisionService, $pbxprojDomXcode, $xcode, $iOSEntitlementsService, $sysInfo, $xCConfigService) {
...
<dict>
    ...
    validatePlugins(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const pluginData of installedPlugins) {
                ...
                const cocoaPodVersion = yield this.$sysInfo.getCocoapodVersion();
    ...
    buildForSimulator(projectRoot, args, projectData, buildOutputStdio) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.xcodebuild(args, projectRoot, buildOutputStdio);
        });
    }
    createIpa(projectRoot, projectData, buildConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            const archivePath = yield this.archive(projectData, buildConfig);
...
<document type="com.apple.InterfaceBuilder3.CocoaTouch.XIB" version="3.0" toolsVersion="6751" systemVersion="14A389" targetRuntime="iOS.CocoaTouch" propertyAccessControl="none" useAutolayout="YES" launchScreen="YES" useTraitCollections="YES">
    ...
    getBuildXCConfigFilePath(projectData) {
        const buildXCConfig = path.join(projectData.appResourcesDirectoryPath, this.getPlatformData(projectData).normalizedPlatformName, "build.xcconfig");
