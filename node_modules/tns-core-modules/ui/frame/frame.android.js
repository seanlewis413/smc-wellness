...
function resetActivityContent(activity) {
...
function setActivityContent(activity, savedInstanceState) {
    var callbacks = activity[CALLBACKS];
    var shouldCreateRootFrame = application.shouldCreateRootFrame();
    var app = application.android;
    var rootView = callbacks._rootView = app.rootView;
    if (!rootView) {
        ...
        callbacks._rootView = app.rootView = rootView;
    }
    if (shouldCreateRootFrame) {
