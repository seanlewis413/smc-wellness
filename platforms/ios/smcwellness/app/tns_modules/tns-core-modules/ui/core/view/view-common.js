...
var ViewCommon = (function (_super) {
    ...
    ViewCommon.prototype._onBackPressed = function () {
        return false;
    };
    ...
    ViewCommon.prototype.showModal = function () {
        if (arguments.length === 0) {
            ...
            view._showNativeModalView(this, context_1, closeCallback, fullscreen, animated);
            return view;
        }
    };
    ...
    ViewCommon.prototype._showNativeModalView = function (parent, context, closeCallback, fullscreen, animated) {
